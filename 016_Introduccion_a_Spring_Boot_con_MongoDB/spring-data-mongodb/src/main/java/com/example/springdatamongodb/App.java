...
import com.example.springdatamongodb.model.Employee;
...
public class App {
    ...
    public static void main(String[] args) {
      ...
      List<Employee> employees = List.of(
              new Employee(null, "emp1", "emp1@gmail.com", LocalDate.of(1998,1,1)),
              new Employee(null, "emp5", "emp5@gmail.com", LocalDate.of(1998,1,1)),
              new Employee(null, "emp3", "emp3@gmail.com", LocalDate.of(1998,1,1)),
              new Employee(null, "emp4", "emp4@gmail.com", LocalDate.of(1998,1,1)),
              new Employee(null, "emp5", "emp5@gmail.com", LocalDate.of(1998,1,1))
