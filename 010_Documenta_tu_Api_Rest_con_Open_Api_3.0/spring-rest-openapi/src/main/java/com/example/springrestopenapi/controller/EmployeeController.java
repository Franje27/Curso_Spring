...
import com.example.springrestopenapi.model.Employee;
...
public class EmployeeController {
    ...
    @Operation(summary = "findAll employees", description = "It retireves all employees from database without pagination")
