...
public class App {
    ...
    public static void main(String[] args) {
       ...
       List<Employee> employees = List.of(
               ...
               new Employee(null, "An O-bierto", LocalDate.of(2001, 1, 1), 70000.0, false ),
               new Employee(null, "Jhon doe", LocalDate.of(1999, 1, 1), 80000.0, true ),
               new Employee(null, "Bob Garcia", LocalDate.of(1980, 1, 1), 30000.0, true )
       );
