    ...
    public static void main(String[] args) {
     ...
     repo.deleteAll();
        ...
        List<Employee> employees = List.of(
                ...
                new Employee(null, "emp3", "emp3@gmail.com", LocalDate.of(1973, 1, 1),true, 60000.0, LocalDate.of(1990, 1,1), LocalDate.of(1990, 1, 1)),
     ...
     repo.findByEmail("emp3@gmail.com").ifPresent(System.out::println);
        ...
        System.out.println("\nfindByAllNameQuery: emp2");
        repo.findAllByNameQuery("emp2").forEach(System.out::println);

        System.out.println("\nfindByAllBirthDayAfter");
        repo.findAllByBirthDateAfter(LocalDate.of(1985, 1, 1)).forEach(System.out::println);

        System.out.println("\nfindByAllBirthDayAfterQuery");
        repo.findAllByBirhtDateAfterQuery(LocalDate.of(1985, 1, 1)).forEach(System.out::println);
        ...
        System.out.println("\nfindAllNameAndEmailAndExcludingId");
        repo.findAllNameAndEmailAndExcludingId().forEach(System.out::println);
